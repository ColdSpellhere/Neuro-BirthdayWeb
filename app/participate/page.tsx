          ...
          <Tabs defaultValue="audience" className="w-full">
            <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 mb-8">
              <TabsTrigger value="audience" className="gap-2">
                ...
                <span className="hidden sm:inline">观众</span>
              </TabsTrigger>
              <TabsTrigger value="submission" className="gap-2">
                <Pencil className="w-4 h-4" />
                <span className="hidden sm:inline">单品投稿</span>
              </TabsTrigger>
              <TabsTrigger value="art" className="gap-2">
                <Image className="w-4 h-4" />
                <span className="hidden sm:inline">贺图投稿</span>
              </TabsTrigger>
              ...
              <Card className="glass-effect border-pink-500/30">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="bg-pink-500/10 border border-pink-500/30 rounded-lg p-4">
                    <p className="text-pink-400 font-medium mb-2">💝 主办方希望你填写</p>
              ...
              <Card className="glass-effect border-cyan-400/30">
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-3">
                    <h3 className="text-lg font-semibold text-white mb-3">投稿要求：</h3>
                    <ul className="space-y-2 text-gray-300">
                      <li className="flex items-start gap-2">
                        <span className="text-pink-400 mt-1">•</span>
                        <span>作品必须为原创内容，严禁抄袭或未经授权的二次创作</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-pink-400 mt-1">•</span>
                        <span>内容需健康向上，符合社区规范，不含敏感或不当内容</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-pink-400 mt-1">•</span>
                        <span>视频类作品请确保画质清晰（推荐 1080p 及以上）</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-pink-400 mt-1">•</span>
                        <span>音频类作品请确保音质清晰，无明显杂音或失真</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <Alert variant="warning" className="border-2">
                    ...
                    <AlertTitle className="text-lg font-bold mb-2">重要提示</AlertTitle>
                  ...
                  <Button size="lg" className="w-full sm:w-auto text-lg" variant="outline"
                   onClick={() => {
                      window.open("https://www.wjx.cn/", "_blank")
                    }}>
                    <ExternalLink className="w-5 h-5 mr-2" />
              ...
              <Card className="glass-effect border-purple-500/30">
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <h3 className="text-lg font-semibold text-white">尺寸要求：</h3>
                      <ul className="space-y-2 text-gray-300">
                        <li className="flex items-start gap-2">
                  ...
                  <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
                    <p className="text-purple-400 font-medium mb-2">🎨 非必填但希望你填</p>
                    <p className="text-sm text-gray-400">
              ...
              <Card className="glass-effect border-cyan-400/30">
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <h3 className="text-lg font-semibold text-white">招募岗位：</h3>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div className="glass-effect p-4 rounded-lg border border-white/10">
                          <h4 className="font-semibold text-pink-400 mb-2">🎬 视频剪辑</h4>
                          <p className="text-sm text-gray-400">
                            负责活动视频的剪辑、特效制作和后期处理
                          </p>
                        </div>
                        <div className="glass-effect p-4 rounded-lg border border-white/10">
                          <h4 className="font-semibold text-cyan-400 mb-2">🎨 平面设计</h4>
                          <p className="text-sm text-gray-400">
                            设计活动海报、宣传物料和视觉元素
                          </p>
                        </div>
                        <div className="glass-effect p-4 rounded-lg border border-white/10">
                          <h4 className="font-semibold text-purple-400 mb-2">📋 活动策划</h4>
                          <p className="text-sm text-gray-400">
                            协助策划活动流程、协调各部门工作
                          </p>
                        </div>
                        <div className="glass-effect p-4 rounded-lg border border-white/10">
                          <h4 className="font-semibold text-yellow-400 mb-2">💬 社区管理</h4>
                          <p className="text-sm text-gray-400">
                            管理社区秩序、回答粉丝问题
                          </p>
                        </div>
                  ...
                  <div className="bg-cyan-400/10 border border-cyan-400/30 rounded-lg p-4">
                    <p className="text-cyan-400 font-medium mb-2">⏳ 需人工审核</p>
                    <p className="text-sm text-gray-400">
